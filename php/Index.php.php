...
<body id="top">
        ...
        <div class="header-content">
            ...
            <nav class="row header-nav-wrap">
                <ul class="header-nav">
                    ...
                    <li><a class="smoothscroll" href="#portfolio" title="Works">Projets</a></li>
                    <li><a href="mailto:#0" title="Contact us">Say Hello</a></li>
                </ul>
            </nav> <!-- end header-nav-wrap -->

            <a href="#0" class="btn btn--stroke btn--small">Télécharger le CV</a>
    ...
    <!-- hero
    ================================================== -->
    <?php include_once("php/PDO/presentationAuteur.php"); ?>
    <section id="hero" class="s-hero target-section" data-parallax="scroll" data-image-src="images/hero-bg-3000.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="row hero-content">
            ...
            <div class="column large-full">
                ...
                <h1>
                Bonjour, je suis Alicia Geran , <br>
                Etudiante en deuxième année de DUT Multimédia et Métiers de l'Internet <br>
                à Sarcelles.
                </h1>
    ...
    <section id="about" class="s-about target-section">
            ...
            <div class="row">
                <div class="column large-6 medium-8 tab-full">
                    ...
                    <div class="section-intro" data-num="01" data-aos="fade-up">
                        <h3 class="subhead">A propos de moi</h3>
                        <h1 class="display-1">Les défis ne me font pas peur</h1>
                    </div>
                    ...
                    <h3 data-aos="fade-up">Profil</h3>

                    <p data-aos="fade-up">
                    Je suis née et ai grandi à Sarcelles. J'ai effectué un DUT MMI dans le but de devenir graphiste.
                    J'aime beaucoup laisser libre cours à mon imagination et ma créativité afin de fournir un travail qui me ressemble.
                    </p>
        ...
        <div class="s-about__section">
            ...
            <div class="row">
                <div class="column">
                    <h3 data-aos="fade-up">Expériences</h3>
                </div>
            </div>
                ...
                <div class="column" data-aos="fade-up">
                    <div class="position">
                        <div class="position__header">
                            <h6>
                                <span class="position__co">Animation After Effects</span>
                                <span class="position__pos">Motion Design</span>
                            </h6>
                        ...
                        <p>
                            Création d'une courte animation d'introduction professionnelle sur After Effects</p>
                            <p>Création d'un moodboard retraçant toutes mes inspirations</p>
                            <p>Création d'un monogramme</p>
                            <p>Création d'une animation sur After Effects avec des effets
